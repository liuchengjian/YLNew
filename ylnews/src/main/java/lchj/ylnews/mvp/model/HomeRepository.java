...
public class HomeRepository implements IModel {
    private String sign = "7c43cc9237ee8c7caf13bc912fe2360c";
    private IRepositoryManager mManager;

    public HomeRepository(IRepositoryManager manager) {
        this.mManager = manager;
    }


    public Observable<ResultInfo<ResultIndex>> getIndexlist() {
